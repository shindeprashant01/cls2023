...
const EducationalDetailsComponents = (props) => {
  ...
  <div className="w3-col m3 note-line">
      ...
      <div className="w3-container w3-card w3-white w3-round w3-margin main-box-update-employee">
        ...
        {/* <div className="w3-dropdown-hover">
          ...
          <div className="w3-dropdown-hover">
          <Link to= {`/achivement_details?emp_id=${emp_id}`} className="w3-bar-item w3-button">
            Achivement & Hobbies
              </Link>
          </div>
          </div>
...
export default EducationalDetailsComponents;