  ...
  <div className="w3-col m3 note-line">
      ...
      <div className="w3-container w3-card w3-white w3-round w3-margin main-box-vendor-regi">
        <div className="container-vendor-regi">
          ...
          <div >
            <h3 style={{color:"rgb(43, 60, 158)"}}> Update Customer Details :</h3>
            ...
            <div>
              ...
              <div className="input-container-vendor-regi">
                <label className="label-vendor-regi"> Customer Address :</label>
                <div className="input-details-vendor-regi">
                <input
                     type="text"
                     name='company_add'
              ...
              <div className="input-container-vendor-regi">
                <label className="label-vendor-regi"> Customer Contact:</label>
                <div className="input-details-vendor-regi">
                <input
                     type="text"
                     name='cust_contact'
              ...
              <div className="input-container-vendor-regi">
                <label className="label-vendor-regi"> Customer Passwaord :</label>
                <div className="input-details-vendor-regi">
                <input
                     type="password"
                     name='cust_pass'
              ...
              <div className="input-container-vendor-regi">
                <label className="label-vendor-regi"> Confirm Password Eamil :</label>
                <div className="input-details-vendor-regi">
                <input
                     type="password"
                     name='vendor_email'
